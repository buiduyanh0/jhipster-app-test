...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '0fee519f-5673-4975-ad5e-9cea09d1aeb3' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('658b811f-2d8c-466a-84af-6896ef1d10c4');
      cy.get(`[data-cy="name"]`).should('have.value', '658b811f-2d8c-466a-84af-6896ef1d10c4');
