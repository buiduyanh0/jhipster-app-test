...
import { sampleWithRequiredData } from '../borrow.test-samples';
...
describe('Borrow Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.borrows()[0]).toEqual(expect.objectContaining({ id: 10965 }));
  });

  describe('trackId', () => {
    it('should forward to borrowService', () => {
      const entity = { id: 10965 };
      jest.spyOn(service, 'getBorrowIdentifier');
      const id = comp.trackId(entity);
      expect(service.getBorrowIdentifier).toHaveBeenCalledWith(entity);
